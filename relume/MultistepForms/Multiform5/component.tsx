...
export type MultiForm5Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
export const MultiForm5 = (props: MultiForm5Props) => {
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <section
        id="relume"
        className="flex grow flex-col justify-center px-[5%] pb-5 pt-10"
      >
    ...
    <div className="flex flex-col gap-y-6">
      <FormField
        ...
        render={({ field, fieldState }) => (
          <FormItem>
            <FormLabel
              className={clsx({ "text-text-error": fieldState.invalid })}
            >
              Enter your name
            </FormLabel>
            <FormControl>
                  ...
                  {serviceTypeData.map((item, index) => {
                    return (
                      <Button
                        ...
                        type="button"
                        variant={
                          field.value === item.value ? "primary" : "secondary"
                        }
            ...
            <FormItem>
              ...
              <FormControl>
                ...
                >
                  <SelectTrigger
                    className={clsx({
                      "border-border-error": fieldState.invalid,
                    })}
                  >
